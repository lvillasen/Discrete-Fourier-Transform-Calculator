...
[my_X_real,my_X_imag] =  dft(xs_window,new Array(xs_window.length).fill(0));
  }
...
if (last == "Function"){
  ...
  function prepareData() {
    ...
    const column = parseInt(String(document.getElementById("column").value));
    ...
    for (var i = 0; i < myArray.length ; i += 1) {
      ...
      xs[i] = parseFloat(myRow[column]);
      if (i< myArray.length/2){frec[i] = i / (N*samplingIntervalData);}
